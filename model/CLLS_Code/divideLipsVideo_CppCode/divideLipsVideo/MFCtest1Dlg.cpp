...
BEGIN_MESSAGE_MAP(CMFCtest1Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_OPEN_VIDEO_BUTTON2, &CMFCtest1Dlg::OnBnClickedOpenVideoButton2)
	//ON_NOTIFY(BCN_DROPDOWN, IDC_OPEN_VIDEO_BUTTON2, &CMFCtest1Dlg::OnDropdownOpenVideoButton2)
END_MESSAGE_MAP()
...
void CMFCtest1Dlg::OnBnClickedOpenVideoButton2()
{
	// TODO:  在此添加控件通知处理程序代码
	CMFCtest1Dlg::OnCancel();
	LoadData Dlg;
	Dlg.DoModal();
}


/*void CMFCtest1Dlg::OnDropdownOpenVideoButton2(NMHDR *pNMHDR, LRESULT *pResult)
{
